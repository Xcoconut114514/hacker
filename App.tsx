...
const App: React.FC = () => {
  return (
    <div className="min-h-screen w-full bg-black relative overflow-hidden flex flex-col text-white selection:bg-white selection:text-black">
      ...
      {/* Main Content Area */}
      <main className="flex-1 flex flex-col md:flex-row items-stretch justify-between px-6 md:px-16 lg:px-24 pt-16 md:pt-24 z-10 w-full max-w-8xl mx-auto relative">
        ...
        <div className="flex-1 w-full md:w-2/5 flex flex-col items-center md:items-end justify-between relative mt-12 md:mt-0 z-30 pb-12">
          
          {/* Spacer to push buttons to center */}
          <div className="hidden md:block flex-grow"></div>

          {/* Buttons Container (Vertically centered "Old Place") */}
          <div className="flex flex-col gap-6 w-full max-w-sm md:max-w-none md:w-auto my-auto">
           ...
           <div className="flex flex-wrap gap-6 items-center justify-center md:justify-end mt-12 md:mt-auto flex-grow-0">
